...
| `maxLength` | `Int` | Positive integer. On a nested field, caps how many array entries are expanded into columns. On a scalar field, values longer than this threshold are truncated to the first (maxLength - 1) characters followed by "...". |
