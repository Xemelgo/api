...
<h1 style={{ color: '#0D8CFF' }}>Asset Management API</h1>
...
## <span style={{ color: '#0D8CFF' }}>Create Assets API</span>

Create Assets API allows to create one or multiple assets with different properties and
...
## <span style={{ color: '#0D8CFF' }}>Update Assets API</span>

Update Assets API allows to update different aspects of multiple assets at the same time.
...
## <span style={{ color: '#0D8CFF' }}>Delete Assets API</span>

Delete Assets API allows you to permanently delete one or more asset records from the system.
...
| Property | Type     | Description                      | Required |
| -------- | -------- | -------------------------------- | -------- |
| assetIds | [String] | List of asset IDs to be deleted. | Yes      |
...
mutation deleteAssets {
  deleteAssets(input: { assetIds: ["R123012"] }) {
    assetIds
  }
}
```
...
| `type`                   | Object       | Asset type of the Asset _(view table below)_                   | No       |
...
| `lastDetectedAtLocation` | Object       | Location at which the Asset was last seen _(view table below)_ | No       |
...
| `customProperties` | AWSJSON | Additional properties for the Asset Type | No       |
      ...
      "assets": [
        {
          ...
          "creationDate": 1711126425177,
          "dueDate": 1719126425177,
          "comments": "Needs inspection in Q3",
          "lastDetectedAtLocation": {
            "id": "Shop Floor",
            "name": "Shop Floor"
          },
...
## <span style={{ color: '#0D8CFF' }}>Get Assets Route API</span>
...
| `location`  | Object       | Location at which the Asset was last seen _(view table below)_ | No       |
...
## <span style={{ color: '#0D8CFF' }}>Postman Collection</span>
